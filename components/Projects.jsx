                   ...
                   hover=
                     {
                       <>
                         ...
                         <Javascript/>
                         <hr className={styles.seperator}/>
                         This very website. It's built with React.js/Next.js and hosted on Raspberry Pi with the help of
                   ...
                   hover=
                     {
                       <>
                         ...
                         <Java/>
                         <hr className={styles.seperator}/>
                         A multi-purpose discord bot that can be used for moderation, fun, and more, for my friend's
                   ...
                   hover=
                     {
                       <>
                         ...
                         <hr className={styles.seperator}/>
                         Web server that also hosts an API for my personal projects. Built with Java and Spring Boot.
                       </>
                     }
        >
          <span className={styles.title}>Project APIs</span>
                   ...
                   hover=
                     {
                       <>
                         ...
                         <hr className={styles.seperator}/>
                         A smart door lock that can be controlled both on-the-spot and remotely via the Blynk platform.
                   ...
                   hover=
                     {
                       <>
                         ...
                         <hr className={styles.seperator}/>
                         A Simple game where you combine similar shapes and avoid other shapes. Built using Unity and
                   ...
                   hover=
                     {
                       <>
                         ...
                         <hr className={styles.seperator}/>
                         A Minecraft mod that adds features to minigames on the Hypixel Network. Built using Java and
                         Forge. </>
                     }
        >
          <span className={styles.title}>Hytils</span>
                   ...
                   hover=
                     {
                       <>
                         ...
                         <hr className={styles.seperator}/>
                         A Minecraft mod that adds game mechanics and features from the Hypixel game mode 'Skyblock' as
                   ...
                   hover=
                     {
                       <>
                         ...
                         <hr className={styles.seperator}/>
                         A simple mod for Minecraft version 1.8.9 that warns you whenever you're health is low. Built
